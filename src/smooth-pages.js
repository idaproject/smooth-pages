(function (root, factory) {
  ...
  var init = function (options) {
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      overlay.style.cssText = "position: fixed; top: 0; right: 0; bottom: 0; left: 0; z-index: 1000; background: " + overlayColor + "; opacity: 1; transition: opacity 0.3s ease-in, z-index 0.3s step-end";
